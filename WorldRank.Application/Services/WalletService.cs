...
namespace WorldRank.Application.Services
{
    public class WalletService
    {
        ...
        {
            var playerId = Prompt.PromptPlayerId();
            if (playerId is null)
                return;

            var currency = Prompt.PromptCurrency();
            if (currency is null)
                return;

            var balance = Prompt.PromptAmount("Initial balance");
            if (balance is null)
                return;
        ...
        public void DepositToWallet()
        {
            ...
            var amount = Prompt.PromptAmount("Amount to deposit");
            if (amount is null)
                return;
        ...
        public void WithdrawFromWallet()
        {
            ...
            var amount = Prompt.PromptAmount("Amount to withdraw");
            if (amount is null)
                return;
        ...
        public void UpdateWalletBalance()
        {
            ...
            var newBalance = Prompt.PromptAmount("New balance");
        ...
        public void ApplyFundsStrategy()
        {
            ...
            var operation = Prompt.PromptFundsOperation();
            if (operation is null)
                return;

            var amount = Prompt.PromptAmount("Amount");
            if (amount is null)
                return;
